...
import com.avramhorseman.runningtracker.other.Constants.REQUEST_CODE_LOCATION_PERMISSION
import com.avramhorseman.runningtracker.other.SortType
...
class RunFragment : Fragment(R.layout.fragment_run), EasyPermissions.PermissionCallbacks {
    ...
    private fun setupRecView() = rvRuns.apply {
