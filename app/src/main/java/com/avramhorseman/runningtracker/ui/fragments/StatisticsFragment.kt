...
import com.avramhorseman.runningtracker.other.CustomMarkerView
import com.avramhorseman.runningtracker.other.TrackingUtility
import com.avramhorseman.runningtracker.ui.viewmodels.StatisticsViewModel
    ...
    private fun subscribeToObservers(){
        ...
        viewModel.totalCaloriesBurned.observe(viewLifecycleOwner){
            it?.let {
                ...
                tvTotalCalories.text = "${totalCaloriesBurned}kcal"
            }

        }

        viewModel.allRunsSortedByDate.observe(viewLifecycleOwner){
            it?.let {
