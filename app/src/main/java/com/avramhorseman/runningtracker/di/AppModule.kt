package com.avramhorseman.runningtracker.di

import android.content.Context
import android.content.Context.MODE_PRIVATE
import android.content.SharedPreferences
import androidx.room.Room
import com.avramhorseman.runningtracker.db.RunningDatabase
...
import com.avramhorseman.runningtracker.other.Constants.RUNNING_DATABASE_NAME
import com.avramhorseman.runningtracker.other.Constants.SHARED_PREF_NAME
...
object AppModule {
    ...
    @Singleton
    @Provides
    fun provideSharedPref(@ApplicationContext app: Context) = app.getSharedPreferences(
